					...
					<div className="rounded-none bg-zinc-50 p-4">
						<div className="mb-4 space-y-2">
							...
							<select
								...
								className="min-h-11 w-full rounded-none bg-white px-3 py-2 pr-10 text-sm text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.18)]">
						...
						<textarea
							className="h-[40vh] w-full resize-none rounded-none bg-white p-3 text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[box-shadow] duration-200 ease-out focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.18)] sm:p-4 md:h-[60vh]"
					...
					<div className="rounded-none bg-zinc-50 p-4">
						<div className="mb-2 flex items-center justify-between">
							...
							<div className="flex gap-2">
								<button
									onClick={handleCopy}
									className={`flex min-h-11 min-w-11 items-center justify-center rounded-none transition-[transform,background-color,box-shadow,color] duration-200 ease-out active:scale-[0.96] ${
										escaped
						...
						<textarea
							className="h-[40vh] w-full resize-none rounded-none bg-white p-3 font-mono text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] sm:p-4 md:h-[60vh]"
							value={escaped}
							readOnly
						/>
					</div>
