...
export default function EpochConverterComponent() {
	...
	return (
		<div className="flex w-full max-w-5xl flex-col gap-6 md:gap-8">
			...
			<div className="rounded-none bg-white p-2 text-center shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.06),0px_2px_4px_0px_rgba(0,0,0,0.04)]">
				<div className="rounded-none bg-zinc-50 p-4">
					...
					<div className="flex items-center justify-center gap-2">
						...
						<button
							...
							className="inline-flex min-h-10 min-w-10 items-center justify-center rounded-none text-zinc-500 transition-[transform,background-color,color] duration-200 ease-out hover:bg-white hover:text-zinc-900 active:scale-[0.96]"
			...
			{/* Settings */}
			<div className="flex flex-wrap justify-center gap-3 rounded-none bg-white p-2 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.06),0px_2px_4px_0px_rgba(0,0,0,0.04)]">
				<div className="flex items-center gap-2">
					<label className="text-sm text-zinc-700">Unit:</label>
					<select
						value={timestampUnit}
						onChange={(e) => setTimestampUnit(e.target.value as TimestampUnit)}
						className="min-h-11 rounded-none bg-zinc-50 px-3 py-2 pr-10 text-sm text-zinc-800 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[box-shadow] duration-200 ease-out focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.18)]">
						<option value="seconds">Seconds</option>
						<option value="milliseconds">Milliseconds</option>
					</select>
				</div>
				<label className="flex min-h-11 items-center gap-3 rounded-none bg-zinc-50 px-3 py-2 text-sm text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)]">
					<input
						type="checkbox"
						id="useLocalTime"
			...
			<div className="flex flex-col gap-6 md:flex-row md:gap-8">
				{/* Epoch to Date */}
				<div className="flex-1 rounded-none bg-white p-2 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.06),0px_2px_4px_0px_rgba(0,0,0,0.04)]">
					<div className="space-y-4 rounded-none bg-zinc-50 p-4">
						...
						<div className="space-y-2">
							<div className="flex gap-2">
								<input
									...
									className="min-h-11 min-w-0 flex-1 rounded-none bg-white px-3 py-2 font-mono text-sm tabular-nums text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[box-shadow] duration-200 ease-out focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.18)]"
								/>
								<button
									onClick={handleUseCurrentEpoch}
									className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-none bg-white text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[transform,background-color,color] duration-200 ease-out hover:bg-zinc-100 hover:text-zinc-900 active:scale-[0.96]"
						...
						{epochError ? (
							<div className="rounded-none bg-red-50 p-3 text-sm text-red-600 shadow-[0px_0px_0px_1px_rgba(220,38,38,0.16)]">
								{epochError}
							</div>
						) : convertedDate ? (
							<div className="rounded-none bg-white p-3 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)]">
								<div className="flex items-start justify-between gap-2">
									<span className="text-sm">{convertedDate}</span>
									<button
										onClick={() => copy(convertedDate)}
										className="inline-flex min-h-10 min-w-10 flex-shrink-0 items-center justify-center rounded-none text-zinc-500 transition-[transform,background-color,color] duration-200 ease-out hover:bg-zinc-100 hover:text-zinc-900 active:scale-[0.96]"
										title="Copy to clipboard">
							...
							<div className="rounded-none border border-dashed border-zinc-300 bg-white/70 p-3 text-center text-sm text-zinc-400">
						...
						<div className="space-y-2">
							<div className="flex gap-2">
								<input
									...
									className="min-h-11 min-w-0 flex-1 rounded-none bg-white px-3 py-2 text-sm text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[box-shadow] duration-200 ease-out focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.18)]"
								/>
								<button
