...
export default function LoremIpsumComponent() {
	...
	return (
		<div className="flex flex-col gap-6 md:flex-row md:gap-8">
					...
					<div className="space-y-5 rounded-none bg-zinc-50 px-4 py-4">
						...
						<div className="space-y-2">
							...
							<input
								...
								min="1"
								max={MAX_COUNTS[type]}
								className="w-full rounded-none bg-white px-3 py-3 text-base tabular-nums shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] transition-[box-shadow] duration-200 ease-out focus:outline-none focus:shadow-[0px_0px_0px_2px_rgba(24,24,27,0.28)]"
							/>
						</div>

						<button
							type="submit"
							className="inline-flex min-h-11 w-full items-center justify-center rounded-none bg-zinc-900 px-4 py-2 text-sm font-medium text-white shadow-[0px_1px_2px_rgba(0,0,0,0.18)] transition-[transform,background-color,box-shadow] duration-200 ease-out hover:bg-zinc-800 hover:shadow-[0px_6px_16px_rgba(0,0,0,0.16)] active:scale-[0.96]">
							Generate
						</button>
					</div>
				</form>

				<div className="flex space-x-2 rounded-none bg-white p-2 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.06),0px_2px_4px_0px_rgba(0,0,0,0.04)]">
					<button
						onClick={handleCopy}
						className={`flex min-h-11 flex-1 items-center justify-center gap-2 rounded-none p-2 text-sm font-medium transition-[transform,background-color,box-shadow,color] duration-200 ease-out active:scale-[0.96] ${
							generatedText
			...
			<div className="order-1 flex-1 overflow-hidden rounded-none bg-zinc-50 p-3 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.06),0px_2px_4px_0px_rgba(0,0,0,0.04)] md:order-2">
				{!generatedText ? (
					<div className="flex h-[40vh] items-center justify-center rounded-none border border-dashed border-zinc-300 bg-white/70 text-zinc-500 md:h-[60vh]">
						<div className="px-6 text-center text-sm text-pretty sm:text-base">Generate text to see the result</div>
					</div>
				) : (
					<div className="h-[40vh] overflow-auto rounded-none bg-white p-4 text-sm whitespace-pre-wrap text-zinc-700 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08)] sm:p-5 sm:text-base md:h-[60vh]">
						{generatedText}
					</div>
				)}
			</div>
